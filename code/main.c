...
int main(void) {
    ...
    tgui_set_root_node(window_node0);
    tgui_node_split(window_node0, TGUI_SPLIT_DIR_VERTICAL, window_node1);
    tgui_node_split(window_node0, TGUI_SPLIT_DIR_VERTICAL, window_node2);
    tgui_node_split(window_node2, TGUI_SPLIT_DIR_HORIZONTAL, window_node3);
    tgui_node_split(window_node2, TGUI_SPLIT_DIR_HORIZONTAL, window_node4);
    tgui_node_split(window_node1, TGUI_SPLIT_DIR_HORIZONTAL, window_node5);
